	...
	public class Result
	{
		...
		public string Output
		{
			get
			{
				...
				Console.WriteLine("The bot could not find any response for the input: " + RawInput + " with the path(s): " + Environment.NewLine + stringBuilder.ToString() + " from the user with an id: " + user.UserID);
				return string.Empty;
			}
		}
